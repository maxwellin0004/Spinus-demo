...
export function CreatorTrendDetailPanels({ initialBatch, initialRec, initialPool }: Props) {
  ...
  return (
    <section id="topic-recommendations" className="scroll-mt-28 grid grid-cols-1 gap-5 xl:grid-cols-[1fr_0.9fr_0.75fr]">
      <div className={cn("rounded-2xl border border-slate-200 bg-white p-5 shadow-sm", loading && "opacity-70")}>
      ...
      <div id="case-study" className={cn("scroll-mt-28 rounded-2xl border border-slate-200 bg-white p-5 shadow-sm", loading && "opacity-70")}>
        <div className="mb-4 flex items-center justify-between">
          <div className="flex items-center gap-2">
      ...
      <div id="task-flow" className={cn("scroll-mt-28 rounded-2xl border border-slate-200 bg-white p-5 shadow-sm", loading && "opacity-70")}>
        <div className="mb-4 flex items-center justify-between">
