...
export const philosophyMontageSubtitleCues = {json.dumps(ts_cues, ensure_ascii=False, indent=2)};
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Generate ElevenLabs TTS audio and subtitle timeline for the philosophy montage preview."
    )
    ...
    timeline = {
        "template_id": payload.get("template_id", "philosophy_montage"),
        "video_id": payload.get("video_id", "digital_minimalism_validation_v2"),
